      ...
      <div className="max-w-7xl mx-auto flex flex-wrap items-center justify-between">
        <div className="flex-1 flex justify-between items-center">
          <div className="flex-1 flex -ml-5">
            <svg
              className="max-w-12 ml-5 md:ml-2 lg:ml-0"
              viewBox="0 0 24 24"
              fill="none"
        ...
        >
          <nav>
            <ul className="md:flex items-center justify-between text-base text-gray-700 pt-4 md:pt-0">
              <li>
                <a
                  className="md:p-4 py-3 px-0 block hover:text-gray-900 transition duration-300"
                  href="#Home"
                >
                  Home
                </a>
              ...
              <li>
                <a
                  className="md:p-4 py-3 px-0 block md:mb-0 mb-2 hover:text-gray-900 transition duration-300"
                  href="#Contact"
                >
                  More
                </a>
