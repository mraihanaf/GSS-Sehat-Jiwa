...
function Qoute(){
    const penjelasan = `"Mens sana in corpore sano"`;
    return(
        <section id="About">
            ...
            <TextRevealByWord text={penjelasan} className=" font-serif">

            </TextRevealByWord>
            <p className="text-center font-semibold text-slate-900">Jiwa yang sehat dalam tubuh yang sehat</p>
            </div>
